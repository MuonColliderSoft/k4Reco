...
RealisticCaloDigi::RealisticCaloDigi(const std::string& name, ISvcLocator* svcLoc)
...
RealisticCaloDigi::operator()(const edm4hep::SimCalorimeterHitCollection& inputSim,
...
StatusCode RealisticCaloDigi::finalize() { return StatusCode::SUCCESS; }
